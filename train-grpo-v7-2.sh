...
OUTPUT_DIR="saves/qwen2_5vl-3b/grpo/adaptive_reasoning_9k_v7_4"
# NUM_GPUS=8
NUM_GPUS=4
ENGINE="vllm"
...
python3 -m verl.trainer.main_ppo \
    ...
    +reward_model.reward_kwargs.type3_format_bonus=0.2 \
    +reward_model.reward_kwargs.type1_error_penalty=-0.15 \
    ...
    trainer.experiment_name='qwen2_5vl_3b_adaptive_9k_v7_4' \
