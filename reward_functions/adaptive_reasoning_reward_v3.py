"""
Adaptive Reasoning Reward Function V3 - Format Bonus + Length Penalty + Diversity Scaling
...
class AdaptiveReasoningReward:
    """
    Reward function with format bonus, dynamic length penalty, and diversity scaling.
    ...
    def __init__(
        ...
        length_threshold: int = 150,      # No penalty below this
        ideal_length: float = 150.0,      # Reference for penalty calculation
...
if __name__ == "__main__":
    ...
    print("="*80)
    print("Adaptive Reasoning Reward Function V3")
    print("Format Bonus + Dynamic Length Penalty + Diversity Scaling")
    print("="*80)
    print("\nReward Design:")
