#!/bin/bash
# GRPO Training with Adaptive Reward V1
# Uses custom reward manager (not custom_reward_function) with skip_special_tokens=False
...
OUTPUT_DIR="saves/qwen2_5vl-3b/grpo/adaptive_reward_v1_full"
NUM_GPUS=8
ENGINE="vllm"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo "  --data_dir <path>      GRPO data directory (default: grpo_data_new)"
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}GRPO Training - Adaptive Reward V1${NC}"
echo -e "${GREEN}========================================${NC}"
...
echo -e "Reward Manager: ${YELLOW}adaptive_reward_v1${NC}"
echo -e "${GREEN}========================================${NC}"
...
python3 -m verl.trainer.main_ppo \
    ...
    reward_model.reward_manager=adaptive_reward_v1 \
    trainer.critic_warmup=0 \
    trainer.logger='["console","tensorboard","wandb"]' \
    trainer.project_name='verl_grpo_adaptive_reward_v1' \
    trainer.experiment_name='qwen2_5vl_3b_adaptive_reward_no_st_full' \
